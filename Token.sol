/**
 *                          
 *      Telegram:   https://t.me/"Enter project TG"
 *      Website:    https://"Enter website address"
 *      Twitter:    https://twitter.com/"Twitter account"
 *
 *      Warning: Contact contains blacklist function, this should only be used upon initial LP creation.
 *      Please contact the DEV team if you believe you have been unfairly blacklisted.
 *      Reward to token holders is in BUSD if enabled
 *      Reward contract address: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
*/         
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // This is BUSD ontract address 
...
contract Shibasheriff is ERC20, Ownable {
    ...
    address public constant token = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // This is BUSD CA
    ...
    // is blacklisted (canot buy, sell, or transger) returns true or false, set to false by default
    ...
    constructor() ERC20("Shiba Sheriff", "SHSF") {
    	...
    	marketingWallet = address(0x314BfEbC283d6d79dD535D8A023705f0551A5C85); // set as marketing wallet

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //Please change address to PEX Router for PEX deployment
    	...
    	// PEX UniSwapV2Router: 0x589634784Db8fE44d4DA8F9125642DA2e69e977F
    ...
    //adding multiple addresses to the blacklist - Used to manually block liquidity bots and scammers
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x314BfEbC283d6d79dD535D8A023705f0551A5C85), //address that liquidity will be added from
            block.timestamp
        );
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10_000 (0,01%) tokens
    }
